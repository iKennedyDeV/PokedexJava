...
public class EvolutionStepTest {
    ...
    public void SeCriaSemArgs(){
        EvolutionStep semNome = new EvolutionStep();
        assertEquals(null,semNome.getMinLevel());
    }
    @Test
    public void seRetornaMinLevel(){
        assertEquals(1,this.pikachus.getMinLevel());
    }

    @Test
    public void seRetornaPokemon(){
        assertEquals("pikachu",this.pikachus.getPokemon().getName());
    }
    @Test
    ...
    public void seRetorThrowPokemonNull(){
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class,() -> new EvolutionStep(1,null));
        assertEquals("Pokemon não pode ser nulo", exception.getMessage());
    }
    @Test
    public void seRetorThrowNivelInvalidoNull(){
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class,() -> new EvolutionStep(null,new Pokemon()));
        assertEquals("Nível mínimo inválido", exception.getMessage());
    }
    @Test
    public void seRetorThrowNivelInvalidoZero(){
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class,() -> new EvolutionStep(-1,new Pokemon()));
        assertEquals("Nível mínimo inválido", exception.getMessage());
    }
