...
public class Ability {
  ...
  public Ability(String name, String description, Types skillType, Boolean hiddenSkill) {
    idCounter += 1;
  ...
  public String toString() {
    var pokemons = new StringBuilder();
    for (Pokemon p : compatiblePokemons) {
      pokemons.append(p.getName()).append(", ");
    }
    String pokemonList =
        pokemons.isEmpty() ? "Nenhum" : pokemons.substring(0, pokemons.length() - 2);
